package it.transaction.atomikos.dao;
...
import it.transaction.atomikos.entities.schema1.Entity1;
...
public class DaoImpl {
	...
	public void createInSchema2(int id, String key, int value) {
		it.transaction.atomikos.entities.schema2.Entity1 entity1 = new it.transaction.atomikos.entities.schema2.Entity1(id, key, value);
